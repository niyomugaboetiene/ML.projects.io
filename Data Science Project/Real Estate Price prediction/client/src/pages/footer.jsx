             ...
             <div className="w-425 flex ms-25 rounded-xl bg-white/20 backdrop-blur-md shadow-lg">
              ...
              <div className="flex space-x-30 mt-25 ms-55">
               ...
               <div className="flex flex-col  font-serif space-y-2 items-center ">
                    ...
                    <Link className="bg-linear-to-b from-purple-400 to-pink-600 bg-transparent text-gray-600 transition duration-500" to="#">
                    ...
                    <Link className="hover:underline hover:text-md transition duration-500">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link className="hover:underline hover:text-md transition duration-500 bg-blue-500 text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
